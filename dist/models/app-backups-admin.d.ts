 ...
 * @enum {string}
 */
export declare const ServerTaskNames: {
    readonly BackgroundTask: "Background Task";
    readonly DatabaseBackup: "Database Backup";
    readonly BulkRecipeImport: "Bulk Recipe Import";
};
 ...
 * @enum {string}
 */
export declare const SupportedMigrations: {
    readonly NextCloud: "nextcloud";
    readonly Chowdown: "chowdown";
    readonly Paprika: "paprika";
    readonly MealieAlpha: "mealie_alpha";
};
