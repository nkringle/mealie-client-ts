...
export declare const ImageType: {
    readonly OriginalWebp: "original.webp";
    readonly MinOriginalWebp: "min-original.webp";
    readonly TinyOriginalWebp: "tiny-original.webp";
};
 ...
 * @enum {string}
 */
export declare const RegisteredParser: {
    readonly Nlp: "nlp";
...
export declare const ReportCategory: {
    ...
    readonly BulkImport: "bulk_import";
};
 ...
 * @enum {string}
 */
export declare const ReportSummaryStatus: {
